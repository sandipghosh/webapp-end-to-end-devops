...
# Returns details about who you are authenticated as when you run AWS CLI commands.
...
echo "Pushed the docker image ${IMAGE_NAME}:${IMAGE_TAG} to AWS ECR"

docker push "${IMAGE_NAME}:latest" 
echo "Pushed the docker image ${IMAGE_NAME}:latest to AWS ECR"

echo "ECR_REPO=${IMAGE_NAME}" >> "$GITHUB_ENV"
echo "Saving the docker container image URL into GitHub environment context"